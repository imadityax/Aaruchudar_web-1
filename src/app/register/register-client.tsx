  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-indigo-50 via-cyan-50 to-blue-50 text-slate-900">
      ...
      <section className="mx-auto max-w-3xl px-6 pb-20">
        {submitted ? (
          /* ✅ THANK YOU MESSAGE (NEW, FORM UI UNTOUCHED) */
          <div className="rounded-3xl border border-slate-200 bg-white/80 backdrop-blur-xl shadow-xl p-12 text-center">
          ...
          <div className="rounded-3xl border border-slate-200 bg-white/80 backdrop-blur-xl shadow-xl">
            <form onSubmit={handleSubmit} className="p-8 sm:p-10 space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="mt-4 w-full rounded-2xl bg-gradient-to-r from-indigo-600 to-cyan-600 px-6 py-4 font-semibold text-white shadow-lg hover:opacity-90 transition disabled:opacity-60"
              >
